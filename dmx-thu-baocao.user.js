...
/* =====================================================================
 * FILE SINH TỰ ĐỘNG — ĐỪNG SỬA TAY. Nguồn: userscript-src/dmx-thu-baocao.js,
 * đóng gói bằng: node tools/dong-goi-userscript.js
 *
 * VỎ TỰ CẬP NHẬT. Mỗi lần trang mở: đọc userscript-ban.json trên
 * namkphong.github.io; nếu có lõi MỚI HƠN bản mang sẵn (0.39.0) thì tải
 ...
 * ===================================================================== */
(function () {
  var TEN = 'dmx-thu-baocao', BAN_GOI = '0.39.0', CO_THU_VIEN = true;
  ...
  function __DMX_LOI_DONG_GOI__(GM_info, GM_getValue, GM_setValue, GM_deleteValue, GM_xmlhttpRequest, unsafeWindow) {
    (function () {
      ...
      var VER = (function () {
        try { return (GM_info && GM_info.script && GM_info.script.version) || '0.39.0'; }
        catch (e) { return '0.39.0'; }
      })();
