...
/* =====================================================================
 * FILE SINH TỰ ĐỘNG — ĐỪNG SỬA TAY. Nguồn: userscript-src/dmx-realtime-auto.js,
 * đóng gói bằng: node tools/dong-goi-userscript.js
 *
 * VỎ TỰ CẬP NHẬT. Mỗi lần trang mở: đọc userscript-ban.json trên
 * namkphong.github.io; nếu có lõi MỚI HƠN bản mang sẵn (0.50.4) thì tải
 ...
 * ===================================================================== */
(function () {
  var TEN = 'dmx-realtime-auto', BAN_GOI = '0.50.4', CO_THU_VIEN = true;
  ...
  function __DMX_LOI_DONG_GOI__(GM_info, GM_getValue, GM_setValue, GM_deleteValue, GM_xmlhttpRequest, unsafeWindow) {
    try { (unsafeWindow.__DMX_LOI = unsafeWindow.__DMX_LOI || {})["dmx-realtime-auto"] = "0.50.4"; } catch (e) {}
    (function () {
      'use strict';
